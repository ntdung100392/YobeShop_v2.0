...
define('DIR_LANGUAGE', '/PHP/yobeshopv20/thuyngamanager/language/');
define('DIR_TEMPLATE', '/PHP/yobeshopv20/thuyngamanager/view/template/');
...
define('DIR_DOWNLOAD', '/PHP/yobeshopv20/system/download/');
...
define('DIR_CATALOG', '/PHP/yobeshopv20/catalog/');
